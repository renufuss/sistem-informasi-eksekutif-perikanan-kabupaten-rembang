<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        <!--begin::Logo image-->
        <a href="#">
            <img alt="Logo" src="<?= base_url(); ?>/assets/media/logos/logo-sidebar.png"
                class="h-70px app-sidebar-logo-default py-1" />
            <img alt="Logo" src="<?= base_url(); ?>/assets/media/logos/logo-small.png"
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link <?php echo (url_is('what-if')) ? 'active' : ''; ?>"
                        href="<?= base_url('what-if'); ?>">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: C:/wamp64/www/keenthemes/core/html/src/media/icons/duotune/general/gen004.svg-->
                            <span class="svg-icon svg-icon-muted svg-icon-2hx"><svg width="24" height="24"
                                    viewBox="-5 -3 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
