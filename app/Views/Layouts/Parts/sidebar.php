    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link <?php echo (url_is('data')) ? 'active' : ''; ?>"
                        href="<?= base_url('data'); ?>">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: C:/wamp64/www/keenthemes/core/html/src/media/icons/duotune/graphs/gra006.svg-->
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link <?php echo (url_is('about')) ? 'active' : ''; ?>"
                        href="<?= base_url('about'); ?>">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: C:/wamp64/www/keenthemes/core/html/src/media/icons/duotune/communication/com014.svg-->
                            <span class="svg-icon svg-icon-muted svg-icon-2"><svg width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
